...
def calculates_results_stats(results_dic):
    ...
    ##n_match = n_dogs_img + n_correct_dogs
    ...
    results_stats['pct_correct_dogs'] = (n_correct_dogs/n_dogs_img) * 100
    results_stats['pct_match'] = (n_match/n_images) * 100
    results_stats['pct_correct_breed'] = (n_correct_breed/n_dogs_img) * 100
    results_stats['pct_correct_notdogs'] = (n_correct_notdogs/n_notdogs_img)*100
